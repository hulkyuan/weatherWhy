...
export default class HomeScreen extends PureComponent {
    ...
    weatherFecth = (location, type) => {
        console.log(location, type, 2222)
        this.setState({
    ...
    openCityView = (event) => {
        ...
        navigation.navigate('City', { name: 'hulk', getCurrentLocation: this.getCurrentLocation, weatherFecth: this.weatherFecth })
    }
    onCloseSearchPanel = () => {
        this.setState({
            searchPanel: false
            ...
            <View style={{ position: "relative", flex: 1 }}>
                ...
                <Animated.FlatList
                    ...
                    onScroll={Animated.event(
                        ...
                        { listener: this.fadeOutBackground, useNativeDriver: true },
                    )}
            ...
            return (
                <View style={{
                    ...
                    >
                        ...
                        <Text style={{ ...styles.lightColor, ...styles.degreeNumberStyle, padding: 5 }}>{tips.observe && observe[0]}</Text>
                    </Animated.View>
